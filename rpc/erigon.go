...
func extractCalls(r *rpc_types.GethTraceCallResult, d *[]*rpc_types.GethTraceCallResult) {
	if r == nil {
		return
	}
	*d = append(*d, r)
...
func (client *ErigonClient) TraceGeth(blockHash common.Hash) ([]*rpc_types.GethTraceCallResult, error) {
...
func (client *ErigonClient) TraceParity(blockNumber uint64) ([]*rpc_types.ParityTraceResult, error) {
...
func (client *ErigonClient) TraceParityTx(txHash string) ([]*rpc_types.ParityTraceResult, error) {
	var res []*rpc_types.ParityTraceResult
