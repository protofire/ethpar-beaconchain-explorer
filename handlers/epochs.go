...
func EpochsData(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Errorf("error retrieving epoch data: %v", err)
	...
	for i, b := range epochs {
		// log.Info("debug", b.Epoch, b.EligibleEther, b.VotedEther, b.GlobalParticipationRate, currency, utils.FormatBalance(b.EligibleEther, currency))
