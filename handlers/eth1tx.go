...
func Eth1TransactionTx(rpc execution.ExecutionClient, bt *db.Bigtable) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			txData, err := eth1data.GetEth1Transaction(common.BytesToHash(txHash), "ETH", rpc, bt)
			if err != nil {
...
func Eth1TransactionTxData(rpc execution.ExecutionClient, bt *db.Bigtable) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
...
func getEth1TransactionTxData(txhash, currency string, rpc execution.ExecutionClient, bt *db.Bigtable) *types.DataTableResponse {
