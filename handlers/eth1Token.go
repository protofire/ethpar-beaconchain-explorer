...
func Eth1Token(bt *db.Bigtable) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		g.Go(func() error {
			var err error
			txns, err = bt.GetTokenTransactionsTableData(token, address, "")
			return err
		})
...
func Eth1TokenTransfers(bt *db.Bigtable) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
